...
<head>
    ...
    <title>Respuesta a Solicitud - Portal de Transparencia Perú</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="#">Portal de Transparencia | Respuesta a Solicitud</a>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <div class="card shadow mb-4 fade-in">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <span class="badge bg-<%= solicitud.getEstadoSolicitudId() == 3 ? "success" : "danger" %>">
                        <%= solicitud.getEstadoSolicitudId() == 3 ? "Atendida" : "Rechazada" %>
                    </span>
                </div>
                <div class="card-body">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            <table class="table table-borderless">
                                ...
                                <tr>
                                    ...
                                    <td><%= solicitud.getFechaRespuesta() != null ? sdf.format(solicitud.getFechaRespuesta()) : "Pendiente" %>
                                    </td>
                                </tr>
                            </table>
                        </div>
            ...
            <div class="card shadow mb-4 fade-in">
                ...
                <div class="card-body">
                    <div class="alert alert-<%= solicitud.getEstadoSolicitudId() == 3 ? "success" : "danger" %>">
                        <i class="bi bi-<%= solicitud.getEstadoSolicitudId() == 3 ? "check-circle" : "exclamation-triangle" %>-fill me-2"></i>
                        <%= solicitud.getEstadoSolicitudId() == 3 ? "Su solicitud ha sido atendida satisfactoriamente." : "Su solicitud ha sido rechazada." %>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><%= solicitud.getFechaRespuesta() != null ? sdf.format(solicitud.getFechaRespuesta()) : "N/A" %>
                                </td>
                            </tr>
                            <tr>
