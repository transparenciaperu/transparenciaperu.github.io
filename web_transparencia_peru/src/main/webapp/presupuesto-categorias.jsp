...
<head>
    ...
    <title>Presupuesto por Categorías | Portal de Transparencia Perú</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="search-container position-relative w-100">
                    <div class="input-group">
                        ...
                        <input class="form-control border-start-0 border-end-0 shadow-sm"
                               type="search"
                               placeholder="Buscar categorías presupuestales..."
                               aria-label="Search"
                               id="searchInput">
...
<div class="hero-section">
    ...
    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="display-5 fw-bold mb-3">Categorías de Gasto</h1>
                <p class="lead">Análisis de la distribución del presupuesto público según categorías funcionales.
                    Compare la asignación de recursos por sector y su evolución.</p>
            </div>
            <div class="col-lg-6">
        ...
        <div class="col-12">
            <div class="info-box">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="ServletPresupuesto?accion=categorias" class="btn btn-primary">Por Categorías</a>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Distribución por Categorías de Gasto
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive mt-4">
                        <table class="table table-hover table-striped">
                            ...
                            <tbody>
                            <c:choose>
                                <c:when test="${not empty datosCategorias}">
                                    <c:forEach var="categoria" items="${datosCategorias}">
                                        <tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        <c:forEach var="categoria" items="${datosCategorias}" varStatus="status">
        categorias.push("${categoria.nombre}");
        montos.push(${categoria.montoTotal / 1000000});
        porcentajes.push(${categoria.porcentaje});
        variaciones.push(${categoria.variacion});
        ...
        if (categorias.length > 0) {
            ...
            const ctxTendencias = document.getElementById('tendenciasCategoriasChart').getContext('2d');
            window.tendenciasChart = new Chart(ctxTendencias, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: variaciones,
                        backgroundColor: variaciones.map(v => v >= 0 ? 'rgba(75, 192, 192, 0.7)' : 'rgba(255, 99, 132, 0.7)'),
                        borderColor: variaciones.map(v => v >= 0 ? 'rgb(75, 192, 192)' : 'rgb(255, 99, 132)'),
                        borderWidth: 1
                    }]
                },
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: {
                            callbacks: {
                                label: function (context) {
                                    const variacion = context.raw;
                                    return `Variación: ${variacion >= 0 ? '+' : ''}${variacion.toFixed(1)}%`;
                                }
                            }
                        }
                    }
            ...
            ['categoriasChartWrapper', 'tendenciasCategoriasChartWrapper'].forEach(id => {
