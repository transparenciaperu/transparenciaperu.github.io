                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td>Marco Legal</td>
                                        <td>Normas de creación, organización y funcionamiento</td>
                                        <td>15/01/2024</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Directorio de funcionarios públicos</td>
                                        <td>05/02/2024</td>
                                        <td><span class="badge bg-success">Publicado</span></td>
                                        <td>
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    ...
                                    <tr>
                                        ...
                                        <td>Declaraciones juradas de ingresos y de bienes y rentas</td>
                                        <td>10/03/2024</td>
                                        <td><span class="badge bg-warning text-dark">Pendiente de actualización</span>
                                        </td>
                                        <td>
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#verDocumentoModal">
                                    ...
                                    <tr>
                                        ...
                                        <td>Comunicados, avisos y otra información relevante</td>
                                        <td>28/04/2024</td>
                                        <td><span class="badge bg-success">Publicado</span></td>
                                        <td>
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td>Listado de Proyectos de Inversión Pública 2024</td>
                                        <td>20/01/2024</td>
                                        <td><span class="badge bg-success">Publicado</span></td>
                                        <td>
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                    ...
                                    <tr>
                                        <td>INFOBRAS</td>
                                        <td>Estado de las Obras Públicas en Ejecución</td>
                                        <td>15/04/2024</td>
                                        <td><span class="badge bg-success">Publicado</span></td>
                                        <td>
                                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
