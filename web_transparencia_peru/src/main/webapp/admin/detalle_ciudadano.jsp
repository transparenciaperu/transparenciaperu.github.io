...
<%
    ...
    // Obtener el ciudadano a mostrar
...
<head>
    ...
    <title>Detalle del Ciudadano - Portal de Transparencia Perú</title>
    ...
    <div class="row">
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom title-section">
                <h1 class="h2">Detalle del Ciudadano</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group me-2">
                        ...
                        <button type="button" class="btn btn-sm btn-outline-danger"
                                onclick="confirmarEliminacion(<%= ciudadano.getId() %>, '<%= ciudadano.getNombres() + " " + ciudadano.getApellidos() %>')">
            ...
            <div class="row">
                    ...
                    <div class="card shadow fade-in">
                        ...
                        <div class="card-body">
                            <div class="text-center mb-4">
                                <img src="https://via.placeholder.com/150" class="img-profile rounded-circle mb-3"
                                     alt="Foto de perfil">
                                <h4><%= ciudadano.getNombres() + " " + ciudadano.getApellidos() %>
                                </h4>
                                <p class="text-muted">Ciudadano</p>
                                <p><span class="badge bg-success"><i
                                        class="bi bi-calendar2-check me-1"></i> Registrado: <%= ciudadano.getFechaRegistro() %></span>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8 mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        <th>Teléfono:</th>
                                        <td><%= ciudadano.getTelefono() != null ? ciudadano.getTelefono() : "No especificado" %>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>Dirección:</th>
                                        <td><%= ciudadano.getDireccion() != null ? ciudadano.getDireccion() : "No especificada" %>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <!-- Sección de actividad reciente del ciudadano -->
                            ...
                            <ul class="timeline">
                                <li class="timeline-item">
                                    ...
                                    <div class="timeline-content">
                                        <h6 class="timeline-title">Solicitud de Acceso a la Información</h6>
                                        <p class="timeline-date"><i class="bi bi-calendar-date me-1"></i> Hace 3 días
                                        </p>
                                        <p>Presentó una solicitud de acceso a documentos del Ministerio de Economía.</p>
                                    </div>
                                </li>
                                <li class="timeline-item">
                                    <div class="timeline-marker bg-info"></div>
                                    <div class="timeline-content">
                                        <h6 class="timeline-title">Participación en Encuesta</h6>
                                        <p class="timeline-date"><i class="bi bi-calendar-date me-1"></i> Hace 15 días
                                        </p>
                                        <p>Participó en la encuesta de satisfacción del portal.</p>
                                    </div>
                                </li>
                                <li class="timeline-item">
                                    <div class="timeline-marker bg-primary"></div>
                                    <div class="timeline-content">
                                        <h6 class="timeline-title">Registro en el Sistema</h6>
                                        <p class="timeline-date"><i
                                                class="bi bi-calendar-date me-1"></i> <%= ciudadano.getFechaRegistro() %>
                                        </p>
                                        <p>Se registró como ciudadano en el portal de transparencia.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
