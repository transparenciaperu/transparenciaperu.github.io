...
<head>
    ...
    <title>Presupuesto por Entidades | Portal de Transparencia Perú</title>
    <!-- Bootstrap CSS -->
                ...
                <div class="search-container position-relative w-100">
                    <div class="input-group">
                        ...
                        <input class="form-control border-start-0 border-end-0 shadow-sm"
                               type="search"
                               placeholder="Buscar entidades públicas..."
                               aria-label="Search"
                               id="searchInput">
                    ...
                    <div class="search-tags d-none d-md-flex justify-content-center mt-2">
                        <span class="badge bg-light text-dark mx-1" style="cursor: pointer;"><i
                                class="fas fa-tag me-1"></i>Ministerio de Economía</span>
                        <span class="badge bg-light text-dark mx-1" style="cursor: pointer;"><i
...
<div class="hero-section">
    ...
    <div class="container position-relative">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <h1 class="display-5 fw-bold mb-3">Presupuesto por Entidades</h1>
                <p class="lead">Visualización detallada del presupuesto asignado a las entidades públicas del Estado
                    Peruano. Compare la distribución de recursos y la ejecución presupuestal por entidad.</p>
            </div>
            <div class="col-lg-6">
        ...
        <div class="col-12">
            <div class="info-box">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <a href="ServletPresupuesto?accion=entidades" class="btn btn-primary">Por Entidades</a>
                ...
                <div class="mt-3">
                    <form action="ServletPresupuesto" method="get">
                        <input type="hidden" name="accion" value="entidades">
                        <div class="row">
                                ...
                                <select class="form-select" id="sectorSelect" name="sector">
                                    ...
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            ...
                                            <option value="Salud" ${sectorSeleccionado == 'Salud' ? 'selected' : ''}>
                                                Salud
                                            </option>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Presupuesto por Entidades
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <c:forEach var="p" items="${presupuestos}">
                                            <c:set var="totalPresupuesto" value="${totalPresupuesto + p.montoTotal}"/>
                                        </c:forEach>
                                        <fmt:formatNumber value="${presupuesto.montoTotal / totalPresupuesto * 100}"
                                                          pattern="#,##0.0"/>%
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="ServletPresupuesto?accion=detalle&id=${presupuesto.id}"
                                           class="btn btn-sm btn-primary">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="ServletPresupuesto?accion=formEditar&id=${presupuesto.id}"
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-4">
                                        <div class="alert alert-warning mb-0">
                                            <i class="fas fa-exclamation-triangle me-2"></i>
                                            No hay datos disponibles para las entidades. Por favor, inténtelo de nuevo
                                            más tarde.
                                        </div>
                                    </td>
                                </tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        if (entidades.length > 7) {
            ...
            // Llenarlos con los datos procesados
            entidades.push(...topEntidades, "Otros");
            montos.push(...topMontos, otrosMontos);
        }

        // Inicializar el gráfico de entidades
        const ctxEntidades = document.getElementById('entidadesChart');

        // Verificar si el elemento existe
        if (ctxEntidades) {
            const ctx = ctxEntidades.getContext('2d');

            // Destruir el gráfico si ya existe para evitar problemas de actualización
            if (window.entidadesChart instanceof Chart) {
                window.entidadesChart.destroy();
            }

            // Solo crear el gráfico si hay datos
            if (entidades.length > 0) {
                window.entidadesChart = new Chart(ctx, {
                    type: 'bar',
                    data: {
                        labels: entidades,
                        datasets: [{
